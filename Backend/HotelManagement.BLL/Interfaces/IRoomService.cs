...
public interface IRoomService
{
    ...
    // Core CRUD
    Task<PaginatedResult<RoomDTO>> GetRoomsAsync(int pageNumber, int pageSize, int? roomTypeId = null, bool includeRetired = false, string? sortBy = null, bool sortDescending = false);
