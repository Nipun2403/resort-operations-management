...
{
    Task<PaginatedResult<RoomTypeDTO>> GetRoomTypesAsync(int pageNumber, int pageSize, bool includeRetired = false, string? searchQuery = null, string? sortBy = null, bool sortDescending = false);
