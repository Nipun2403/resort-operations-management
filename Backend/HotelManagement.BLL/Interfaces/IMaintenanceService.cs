...
{
    Task<PaginatedResult<MaintenanceTaskDTO>> GetAllTasksAsync(int pageNumber, int pageSize, string? status = null, string? sortBy = null, bool sortDescending = false, bool assignedToMe = false);
