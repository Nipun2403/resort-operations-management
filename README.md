...
<details>
<summary><strong>🏆 2. Automated Audit Logging — ORM-Level Change Data Capture</strong> (Click to expand)</summary>
...
<details>
<summary><strong>🏆 3. End-to-End Idempotency System</strong> (Click to expand)</summary>
...
<details>
<summary><strong>🏆 4. Real-Time SignalR Notifications with Role-Based Broadcasting</strong> (Click to expand)</summary>
...
<details>
<summary><strong>🏆 5. Multi-Dimensional Analytics with PostgreSQL Stored Procedures</strong> (Click to expand)</summary>
...
<details>
<summary><strong>🏆 6. AI Concierge — Conversational Guest Assistant with Real Action Execution</strong> (Click to expand)</summary>
...
<details>
<summary><strong>🖼️ Staff Operations Dashboards</strong> (Click to expand)</summary>

| Role | Dashboard Features |
|------|-------------------|
| **Front Desk** | Booking management, check-in/out, guest search, unified checkout with folio |
| **Kitchen** | Order queue with status transitions (Pending → Preparing → Ready → Delivered), real-time alerts |
| **Housekeeping** | Task board with room status, priority, turnaround timing, guest-triggered requests |
| **Maintenance** | Ticket queue with emergency flag, room location, status workflow |
...
│   └── Dockerfile
│
├── Documents/                         # Architecture & feature docs
│   ├── FEATURE_LIST.md                # Detailed feature showcase
│   ├── Architecture.md                # Architecture documentation
│   ├── Frontend_Security_Features_Report.md
│   ├── AI_CONCIERGE_FEATURE_UNDERSTANDING.md
│   └── ... (20+ technical documents)
│
├── scripts/                           # Deployment & utility scripts
├── presentation/                      # Slide decks & demo scripts
...
- **OpenAI** for GPT-4o-mini powering the AI Concierge
