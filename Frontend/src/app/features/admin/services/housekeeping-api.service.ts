...
export class HousekeepingApiService {
  ...
  getAll(params?: { status?: string; pageNumber?: number; pageSize?: number }): Observable<HousekeepingTask[]> {
    ...
    return this.http.get<HousekeepingTask[]>(this.baseUrl, { params: httpParams });
  }
