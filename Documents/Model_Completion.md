...
FILES MODIFIED (existing files updated per spec)
-------------------------------------------------
✓ Frontend/src/app/features/public/pages/room-catalogue.component.ts — replaced Record card classes with getCardClass string mapping helper
✓ Frontend/src/app/features/public/pages/room-catalogue.component.html — added glass-morphic overlay on card 1 and conditional details rendering
✓ Frontend/src/app/features/public/pages/room-catalogue.component.scss — added overlay blurs, reverted offsets and spans

REQUIREMENTS IMPLEMENTED
------------------------
✓ Room Catalogue Paginated Scroll (Final)
  ✓ Displaying exactly 4 cards at a time using computed displayedRooms slice
  ✓ Asymmetric card column spans: card 1 (span 8), card 2 (span 4), card 3 (span 5), card 4 (span 7) with 8rem design gaps
  ✓ Glass-morphic text and stats overlay on Card 1 container
  ✓ External card body details restricted to Cards 2-4
  ✓ Mouse wheel and touch drag swipe navigation to paginate cards in sets of 4
  ✓ Left/right arrow buttons overlaid on desktop viewport to paginate groups
  ✓ Group index page label indicator (e.g. "1 / 3")
  ✓ Gold wash sweep animation overlay on transitioning state (goldSweep keyframes)
